...
{
    private static String LOG_TAG = ScoresAdapter.class.getSimpleName();
...
//            int leagueInt = cursor.getInt(ScoresTable.COL_LEAGUE);
//            String leagueText = Utilities.getLeague(leagueInt);
//            Log.d(LOG_TAG, "League#: " + leagueInt + "; League name: " + leagueText);
